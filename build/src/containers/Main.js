...
export default function () {
    ...
    //   getData();
    // }, []);
    return (_jsxs(_Fragment, { children: [_jsx("div", { id: 'metrics', children: _jsx("div", { id: 'charts', children: charts?.map((chart, i) => {
                        // console.log(chart);
                        return (_jsx(Chart, { props: chart, id: chart.metric }, chart.metric));
                    }) }) }), _jsx(SearchBar, {})] }));
}
